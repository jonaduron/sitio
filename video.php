...
<head>
    ...
    <link rel="stylesheet" href="css/diseñoVideo.css">
    <link rel="stylesheet" href="css/bootstrap.min.css">
    <link rel="stylesheet" href="css/diseñoAudio.css">
    <link rel="stylesheet" href="css/diseñoPDF.css">
    ...
    <div class="container_Video" id="Video">    
        <div id="main" class="containerVideo">
            ...
            <video id="video" class="video">
                <source src="SpaceX Falcon Heavy.mp4"> 
            </video>
...
<div class="pull-right pt-5"><a href="Temario.php" style="text-decoration: none; color:rgba(255, 255, 255, 0.63);">ir al temario</a></div>
    ...
    <div class="container_Audio" id="Audio" style="display:none;">
        <div class="containerAudio">    
            <audio class="audio">
                <source src="Alan Walker - Faded (Instrumental Version).mp3"> 
            </audio>
    ...
    <div class="container_PDF" id="PDF" style="display:none;"> 
        <div class="container">
            ...
            <iframe src="UnidadesTematicas_Programacion.pdf#page=17" style="width: 100%;height: 100%;" ></iframe>
        </div>
    </div>
    ...
    <script>
        ...
        $("#expand_btnVideo").click(function()
        {
            //SiguienteVideo();
            alert('hola');
        });
