...
<body>
    <div class="container">
        <form action="session.php" method="POST" class="login">
            <h1 class="title"><h3></h3><img class="login-img" src="http://cursos.utags.edu.mx/pluginfile.php/1/core_admin/logo/0x200/1536301315/logo.png" title="Plataforma de Cursos" alt="Plataforma de Cursos"> <h3></h3></h1>
                <br>
