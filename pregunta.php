    ...
    <div class="container pt-5">
        <div class="row pt-5">
            ...
            <div class="columna1 col-lg-6 text-center">
                <img src="images/rocket .png" class="py-4" alt="">
                <br>
            ...
            <div class="col-lg-6 text-center">
                <img src="images/apple.png" class="py-4" alt="">
                <br>
                <a href="Temario.php"> <button type="button" class="btn  botonBlanco text-white font-weight-bold "><h4>Tomar examen diagnostico </h4> </button></a>
            </div>
        </div>
    </div>
